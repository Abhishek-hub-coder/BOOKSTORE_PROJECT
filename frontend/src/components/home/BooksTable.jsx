    ...
    <table className='w-full border-separate border-spacing-2'>
      ...
      <thead>
        <tr>
          ...
          <th className='border border-slate-600 rounde-md max-md:hidden'>Author
          </th>

          <th className='border border-slate-600 rounde-md max-md:hidden'>PublishYear
          </th>
          <th className='border border-slate-600 rounde-md'>Operations
          </th>
        </tr>
      </thead>
